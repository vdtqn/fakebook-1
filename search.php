...
<div class="main_column column" id="main_column">
    <?php 
        if ($query == "") {
            ...
            echo "<a href='search.php?q=" . $query ."&type=name'>Names</a>, <a href='search.php?q=" . $query ."&type=username'>Usernames</a><br><br><br><hr id='search_hr'>";
            ...
            while($row = mysqli_fetch_array($usersReturnedQuery)) {
                ...
                if ($user['username'] != $row['username']) {
                    ...
                    //Generate button depending on driendship status
